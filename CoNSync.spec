...
License:        GPLv3+
URL:            https://github.com/FDH2/CoNSync
Source0:        https://github.com/FDH2/CoNSync/archive/%{gittag}/%{name}-%{version}.tar.gz

Packager:       CoNSync maintainer
...
# Note that CoNSync does not have a "GPL exception" allowing it to be
...
%files
%{_bindir}/CoNSync
%{_bindir}/CoNSync-beacon.py
%{_bindir}/CoNSync_beacon_module_BlueZ.py
%{_bindir}/CoNSync_beacon_module_BleuIO.py
%{_bindir}/CoNSync_beacon_module_HCI.py
%{_mandir}/man1/CoNSync.1*
%{_mandir}/man1/CoNSync-beacon.1*

%doc
%{_docdir}/%{name}/README.txt
#%{_docdir}/%{name}/README.html
%{_docdir}/%{name}/README.md
%{_docdir}/%{name}/systemd/CoNSync.service
...
%changelog
* Thu June 25 2026 maintainer <https://github.com/FDH2/CoNSync>
  Update for 1.74 release
  Comment out references to avahi, for build using internal mdns
* Wed Feb 11 2026 CoNSync maintainer <https://github.com/FDH2/CoNSync>
  Update for 1.73.2 release
* Tue Jan 27 2026 CoNSync maintainer <https://github.com/FDH2/CoNSync>
  Update for 1.73 release
* Mon Jul 7 2025 CoNSync maintainer <https://github.com/FDH2/CoNSync>
  Update for 1.72.2 release
* Fri Nov 15 2024 CoNSync maintainer <https://github.com/FDH2/CoNSync>
  Initial CoNSync.spec: tested on Fedora 38, Rocky Linux 9.2, OpenSUSE
