...
#----------------------------------------------------------------
# BlueZ/D-Bus (Linux) module for a standalone python-3.6 AirPlay Service-Discovery Bluetooth LE beacon for CoNSync 
...
print(f'loaded CoNSync_beacon_module_BlueZ ')
