...
#----------------------------------------------------------------
# HCI_Linux (uses sudo hciconfig):  module for a standalone python-3.6 or later AirPlay Service-Discovery Bluetooth LE beacon for CoNSync 
...
# (3) add the users who will run CoNSync-beacon.py to the group hciusers
...
if linux:
    ...
    * for older FreeBSD releases is available at the CoNSync Wiki site:    *
    * https://github.com/FDH2/CoNSync/wiki/hccontrol-patch-for-FreeBSD-15.0*
    ***********************************************************************
    '''
    ...
    '''
help_text3 = '''
     (3) add users of CoNSync_beacon_module_HCI.py to the group "hciusers"
'''
...
print('loaded CoNSync_beacon_module_HCI')
