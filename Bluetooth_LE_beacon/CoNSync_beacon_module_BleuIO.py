...
#----------------------------------------------------------------
# BleuIO (for BleuIO UB serial device)  module for a standalone python-3.6 or later AirPlay Service-Discovery Bluetooth LE beacon for CoNSync 
...
def setup_beacon(ipv4_str: str, port: int, advmin: int, advmax: int, index: Literal[None]) ->bool:
    ...
    if index is not None:
        raise ValuError('CoNSync_beacon_module_BleuIO called with value of index: not None')
...
print(f'Imported CoNSync_beacon_module_BleuIO')
